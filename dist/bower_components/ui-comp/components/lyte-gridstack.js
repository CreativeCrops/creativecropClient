...
// after rendering properties
    ...
    data : function(){
        return {
            ...
            ltPropMarginLeft : Lyte.attr("number",{"default":20}), 
            ltPropMarginTop : Lyte.attr("number",{"default":20}), 
            ...
            ltPropGridSpaceColor : Lyte.attr('string', { default : '#f5f5f5' }),
            ...
            ltPropMarginLeftCopy : Lyte.attr("number",{"default":20}), 
