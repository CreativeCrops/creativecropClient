...
//                        node.childNodes[i].setAttribute("index1", index-1);
    ...
    function newGetDeepNodes(componentName,node, deepNodes, deepN, is,strict,errors,warnings) {
        ...
        if(is === "registerYield" || is === "yield") {
            var dynamicNodes = [];
            this.processTemplate(node.content, dynamicNodes, componentName);
        ...
        if(is === "for") {
            ...
            if(template) {
                ...
                var dynamicNodes = [];
                this.processTemplate(node._forTemplate.content, dynamicNodes, componentName,strict,errors,warnings);
            ...
            if(template) {
                ...
                var dynamicNodes = [];
                this.processTemplate(node._forInTemplate.content, dynamicNodes ,componentName,strict,errors,warnings);
