    ...
    computeOffsetImplOnResize : function(){
        /*------------------------------ MEASURE STARTS --------------------------*/
         $L.fastdom.measure(function() {   
            ...
            // console.log(prevWinH +"      "+ h + "       " + (prevWinH - h));
            // modalEle.style.transform = "translate("+newLeft+"px,"+newTop+"px)";
            // console.log("translate("+newLeft+"px,"+newTop+"px)");
                ...
                /*------------------------------ MUTATE STARTS --------------------------*/
                 $L.fastdom.mutate(function() {
                    if(this.getData('ltPropTransition').animation == "slideFromTop"){
                        ...
                        this.enableTransform(parseInt(offsetObj.top)+modalElePosition.height,"y");
                    }
                    else if(this.getData('ltPropTransition').animation == "slideFromBottom"){
                        modalEle.style.left = offsetObj.left;
                        modalEle.style.top = h+1 + "px";
                        this.enableTransform(-1 * (h - parseInt(offsetObj.top)),"y");
                    }
                        ...
                        this.enableTransform(parseInt(offsetObj.left)+modalElePosition.width,'x');
                    }
                    else if(this.getData('ltPropTransition').animation == "slideFromRight"){
                        modalEle.style.top = offsetObj.top;
                        modalEle.style.left = w + 1 + "px";
                        this.enableTransform(-1 * (w - parseInt(offsetObj.left)),'x');
                    }
                ...
                /*------------------------------ MUTATE STARTS --------------------------*/
                 $L.fastdom.mutate(function() {
                    if(this.getData('ltPropTransition').animation == "slideFromTop"){
                        ...
                        modalEle.style.top = (-1 * modalElePosition.height) + "px";
                        this.enableTransform(parseInt(offsetTop)+modalElePosition.height,"y");
                    }
                    else if(this.getData('ltPropTransition').animation == "slideFromBottom"){
                        modalEle.style.left = offsetLeft + "px";
                        modalEle.style.top = h+1 + "px";
                        this.enableTransform(-1 * (parseInt(offsetTop) + modalElePosition.height),"y");
                    }
                    else if(this.getData('ltPropTransition').animation == "slideFromLeft"){
                        modalEle.style.top = offsetTop + "px";
                        modalEle.style.left = (-1 * modalElePosition.width) + "px";
                        this.enableTransform(parseInt(offsetLeft)+modalElePosition.width,'x');
                    }
                    else if(this.getData('ltPropTransition').animation == "slideFromRight"){
                        modalEle.style.top = offsetTop + "px";
                        modalEle.style.left = w + 1 + "px";
                        this.enableTransform(-1 * (parseInt(offsetLeft) + modalElePosition.width),'x');
                    }
                    else if(this.getData('ltPropTransition').animation == "fadeIn"){
                        this.$node.ltProp('showCopy',true);
                        modalEle.style.left = offsetLeft + "px";
